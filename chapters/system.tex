...
根据第三章增加日常可用性的思路，本文同样用让用户参与设计过程的设计方法，邀请用户在日常使用的过程中参与迭代过程，最后实现了可用性设计原型。
...
本小节将介绍本文如何在系统设计层面解决我们在上一章发现的技术敏感性问题以及为可解释性设计提供基础：
...
在面诊系统的基础上，本文实现了两个交互设计，用于后续在实验中验证本文所提出的设计策略的有效性。