...
技术探针是交互领域中一种用户参与的设计方法，把用户带到真实的场景中来收集用户相关信息。本文使用诊所环境下的一款面诊应用（云中医）作为技术探针，通过对参与者在日常场景下使用云中医的体验情况进行深度访谈，分析转录成文字后的访谈资料，发现了面诊技术在日常场景下会遇到长期使用、实用性、敏感性、情绪与信赖等方面的问题。针对这些问题，本文提出了对应的设计思路：系统可解释性、日常可用性。
