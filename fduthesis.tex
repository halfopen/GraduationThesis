...
为了解决当前面诊系统不能应用到日常健康场景的问题，本文通过人机交互设计方法做了以下探索：开发出云中医应用作为技术探针，招募用户在其日常生活中进行为期3周的实地试用，并对他们使用前后的体验进行深度用户访谈。
通过定性分析转录成文字后的访谈资料，发现了面诊技术在日常健康场景下会遇到持续使用、实用性、敏感性、情绪与信赖相关的交互设计问题，以及用户设备多样性带来的稳定性问题等方面的问题。

2.针对之前发现的面诊技术应用于日常健康场景存在的设计问题，提出了相应的系统交互设计方案。
(1) 在交互设计层面，初步提出了对应的设计策略：增加系统可解释性、提高日常可用性，以解决系统实用性和用户信赖的问题。
