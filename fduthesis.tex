...
\begin{abstract}
  本文通过调研人脸识别技术应用到面诊进行日常的健康管理，探索在日常健康管理的场景下会遇到的问题并提出了交互上改进的方法。以云中医app为原型，重新设计了整个中医面诊系统，提高系统的可用性。同时，重新实现诊断算法，在用户使用的过程中加入透明性，经过用户调研，透明性的加入能够大大提高用户对于中医知识的理解程度。
\end{abstract}
