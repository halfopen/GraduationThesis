...
为了验证设计方案，本文分别实现了解决可用性问题的原型和添加解释的原型，并通过实地调研的方式验证了设计方案的有效性。在实现可解释的设计过程中，探索了如何对系统的背后原理以及影响权重进行解释。
...
\begin{abstract*}
  ...
  With the development of economy, the acceleration of people's life rhythm and the gradual improvement of health care awareness, more and more people begin to pay attention to their own health problems, but the compact working time makes the vast majority of people unable to take the time to go to the hospital alone to check their health condition regularly.

  In recent years, with the popularity and development of mobile devices, the performance of mobile devices has been greatly improved, and a large number of health tracking technologies in daily scenes are also in-depth.
  
  With the rapid development of artificial intelligence technology, the ability of health diagnosis algorithm is also constantly improving, especially based on facial information diagnosis technology is also constantly breaking through, it is possible to carry out daily health diagnosis based on facial information on mobile devices.
  
  
  
  At present, the main application scenario of the existing face-to-face clinic information technology is in the clinic environment. Although there are a lot of health management technologies in the field of human-computer interaction (HCI) in the daily scenario, they mainly focus on user health behavior guidance and how to help users better manage chronic diseases.
  ...
  \item Qualitative study of the application of the technique probe in the daily scene.
  Through in-depth interviews with participants and analysis of the interview materials transcribed into text, the problems encountered in the clinical application under the daily scenario are explored and the design scheme is proposed: increase variability, system transparency and daily availability.
  
  
  
  \item The experiment platform is designed and implemented.
 Before the interactive experiment, in order to improve the efficiency of the follow-up experiment and solve the problem of stability brought by the diversity of user equipment, the experimental platform for the rapid development of face-to-face clinical application experiments is designed and implemented: the system is highly available, fast iterative, model task module separation, user operation record management, questionnaire correlation and other functions are realized, which improves the stability of the system Qualitative, can deal with the large-scale user experiment scene, and quickly carry out new experiments.
  
  
  
  
    \item  Using the experimental platform, we verify and analyze the design scheme of increasing the system transparency and increasing the daily availability.
