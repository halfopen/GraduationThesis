...
1.利用技术探针方法揭示面诊技术应用在日常健康场景下存在的交互设计问题并提出设计策略。
日常健康场景与诊所的标准环境相比，场景更加复杂，用户真实想法难以获取。技术探针是人机交互领域中一种用户参与的设计方法，该方法能够把用户带到真实的场景中来收集用户相关信息。
为了解决当前面诊系统不能应用到日常健康场景的问题，本文通过技术探针方法做了以下探索：(1) 开发出云中医应用作为技术探针，招募用户在其日常生活中进行为期3周的实地试用，并对他们使用前后的体验进行深度用户访谈。
通过分析转录成文字后的访谈资料，发现了面诊技术在日常健康场景下会遇到持续使用、实用性、敏感性、情绪与信赖相关的交互设计问题，以及用户设备多样性带来的稳定性问题等方面的问题。
(2) 针对发现的问题，本文提出了对应的设计策略：增加系统可解释性、提高日常可用性、支持可持续使用等方面以指导未来的面诊系统设计。

2.针对之前发现的面诊技术应用于日常健康场景存在的设计问题，根据交互策略提出了相应的系统设计方案。
